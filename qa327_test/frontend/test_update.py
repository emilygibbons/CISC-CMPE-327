...
test_tickets = [
    {'name': 'ticket1test', 'price': 100,
        'email': 'test_frontend@test.com', 'date': '20200901'}
]

test_tickets_unmodify = [
        {'name': 'tickettest', 'price': 100,
         'email': 'test_frontend@test.com', 'date': '20220901'}
]
test_tickets_modify = [
        {'name': 'ticket1test', 'price': 80,
         'email': 'test_frontend@test.com', 'date': '20220901'}
]
...
class FrontEndUpdateTesting(BaseCase):
    ...
    def test_ticketname(self, *_):
        ...
        self.assert_text(
            "The updated name has to alphanumeric, have no spaces in the begining or end and be between 6 and 60 characters.", "#updateMessage")
    ...
    def test_ticketnamelength(self, *_):
        ...
        self.type("#quantity-new", "1")
        self.type(
            "#name-new", "qqqwwweeerrrtttyyyuuuiiiooopppaaasssdddfffggghhhjjjkkkllzzzxxxx")
        self.type("#price-new", "100")
        self.type("#expiration-date-new", "20210901")
        # click update button
        self.click('input[id="btn-update-submit"]')
    ...
    def test_ticketquantity(self, *_):
        ...
        self.assert_element("#updateMessage")
        self.assert_text(
            "The updated quantity of tickets needs to be between 1 and 100.", "#updateMessage")
    ...
    def test_ticketprice(self, *_):
        ...
        self.assert_element("#updateMessage")
        self.assert_text(
            "The updated price needs to be between $10 and $100.", "#updateMessage")
    ...
    def test_ticketdateformat(self, *_):
        ...
        self.assert_element("#updateMessage")
        self.assert_text(
            "The updated exipiration date needs to be follow the 'YYYYMMDD' format.", "#updateMessage")
    ...
    def test_ticketnameexists(self, *_):
        ...
        self.assert_element("#updateMessage")
        self.assert_text(
            "The entered ticket either does not exist or was entered incorrectly, please try again.", "#updateMessage")
